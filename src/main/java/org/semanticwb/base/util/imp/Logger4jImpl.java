...
public class Logger4jImpl implements Logger {
	 ...
	 * <p>
	 * Referencia a la clase (tipo) del objeto desde la que se usar&aacute; el
	 * logger.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>TRACE</q> kind of message in the log. This kind of message must provide
	 * the information needed to trace an error or exceptional condition.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>TRACE</q> en la bit&aacute;cora. Este tipo de mensaje debe proveer la
	 * informaci&oacute;n necesaria para rastrear un error o condici&oacute;n
	 * excepcional.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>DEBUG</q> kind of message in the log. This kind of message must provide
	 * information for bug identification and resolution.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>DEBUG</q> en la bit&aacute;cora. Este tipo de mensaje debe mostrar
	 * informaci&oacute;n para identificaci&oacute;n y resoluci&oacute;n de bugs.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>INFO</q> kind of message in the log. This kind of message provides
	 * information in a general manner.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>INFO</q> en la bit&aacute;cora. Este tipo de mensaje muestra
	 * informaci&oacute;n de manera general.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>WARN</q> kind of message in the log. This kind of message provides a
	 * warning about a certain situation.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>WARN</q> en la bit&aacute;cora. Este tipo de mensaje provee una
	 * advertencia sobre cierta situaci&oacute.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>ERROR</q> kind of message in the log. This kind of message provides notice
	 * of an error and information related to that error.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>ERROR</q> en la bit&aacute;cora. Este tipo de mensaje provee
	 * notificaci&oacute;n sobre un error e informaci&oacute;n relacionada a ese
	 * error.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>FATAL</q> kind of message in the log. This kind of message provides notice
	 * of a situation from which the application cannot recover.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>FATAL</q> en la bit&aacute;cora. Este tipo de mensaje provee
	 * notificaci&oacute;n de una situaci&oacute;n de la que la aplicaci&oacute;n no
	 * se puede recuperar.
	 * </p>
	 */
	...
	/**
	 * Identifier for the
	 * <q>EVENT</q> kind of message in the log. This kind of message provides notice
	 * of the happening of a specific event.
	 * <p>
	 * Identificador para el tipo de mensaje
	 * <q>EVENT</q> en la bit&aacute;cora. Este tipo de mensaje provee
	 * notificaci&oacute;n de la ocurrencia de un evento espec&iacute;fico.
	 * </p>
	 */
	 ...
	 * <p>
	 * Crea una instancia de este logger asociando la clase que lo usar&aacute;.
	 * </p>
	 * 
	 * @param cls
	 *            the object class from which the logger will be used
	 */
