...
public class SWBProperties extends Properties {
	 ...
	 * "http://java.sun.com/docs/books/jls/second_edition/html/lexical.doc.html#100850">&sect;3.3</a>
	 * and <a href=
	 * "http://java.sun.com/docs/books/jls/second_edition/html/lexical.doc.html#101089">&sect;3.10.6</a>
	 ...
	 * <code>\r</code> or <code>\r\n</code>) or by the end of the file. A natural
	 ...
	 * line terminator sequence with a backslash character, <code>\</code>. Note
	 ...
	 * terminators, this method considers the characters space (<code>' '</code>,
	 ...
	 * Note that it is <i>not</i> sufficient to only examine the character preceding
	 ...
	 * number of 2<i>n</i> contiguous backslashes before a line terminator (or
	 ...
	 *             <code>Properties</code> table (if any) are <i>not</i> written out
	 *             by this method.
	 *             <p>
	 *             If the header argument is not null, then an ASCII <code>#</code>
	 *             character, the header string, and a line separator are first
	 *             written to the output stream. Thus, the <code>header</code> can
	 *             serve as an identifying comment.
	 *             <p>
	 *             Next, a comment line is always written, consisting of an ASCII
	 *             <code>#</code> character, the current date and time (as if
	 *             produced by the <code>toString</code> method of <code>Date</code>
	 *             for the current time), and a line separator as generated by the
	 *             Writer.
	 *             <p>
	 *             Then every entry in this <code>Properties</code> table is written
	 *             out, one per line. For each entry the key string is written, then
	 *             an ASCII <code>=</code>, then the associated element string. Each
	 *             character of the key and element strings is examined to see
	 *             whether it should be rendered as an escape sequence. The ASCII
	 *             characters <code>\</code>, tab, form feed, newline, and carriage
	 *             return are written as <code>\\</code>, <code>\t</code>,
	 ...
	 *             value <i>xxxx</i>. For the key, all space characters are written
	 *             with a preceding <code>\</code> character. For the element,
	 *             leading space characters, but not embedded or trailing space
	 *             characters, are written with a preceding <code>\</code>
