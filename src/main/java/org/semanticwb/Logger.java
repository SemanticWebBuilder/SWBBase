 ...
 * purposes.
 * <p>
 * Registra informaci&oacute;n o mensajes en el archivo de bit&aacute;cora de la
 * aplicaci&oacute;n con diferentes prop&oacute;sitos.
 * </p>
 * 
 * @author Javier Solis
 */
public interface Logger {
	 ...
	 * <p>
	 * Registra los elementos de la pila de ejecuci&oacute;n del hilo al momento en
	 * que es llamado, junto con un mensaje para proveer informaci&oacute;n sobre
	 * una condici&oacute;n excepcional a fin de rastrear su origen.
	 * </p>
	 * 
	 * @param txt
	 ...
	 * <p>
	 * Registra un mensaje para proveer informaci&oacute;n sobre una
	 * condici&oacute;n excepcional a fin de rastrear su origen.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
	 ...
	 * <p>
	 * Registra los elementos de la pila de ejecuci&oacute;n del hilo al momento en
	 * que es llamado para proveer informaci&oacute;n sobre una condici&oacute;n
	 ...
	 * Registra los elementos de la pila de ejecuci&oacute;n del hilo al momento en
	 * que es llamado, junto con un mensaje, para proveer informaci&oacute;n sobre
	 * una condici&oacute;n excepcional.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
	 ...
	 * <p>
	 * Registra una condici&oacute;n excepcional en la ejecuci&oacute;n del hilo
	 * actual.
	 * </p>
	 * 
	 * @param t
	 ...
	 * <p>
	 * Registra informaci&oacute;n a manera de advertencia sobre una
	 * condici&oacute;n excepcional generada.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
	 ...
	 * <p>
	 * Registra un mensaje a manera de advertencia sobre una condici&oacute;n
	 ...
	 * <p>
	 * Registra informaci&oacute;n para reportar un error en la aplicaci&oacute;n.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
	 ...
	 * <p>
	 * Registra un mensaje para reportar un error en la aplicaci&oacute;n.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
	 ...
	 * <p>
	 * Registra informaci&oacute;n sobre una condici&oacute;n excepcional generada
	 ...
	 * <p>
	 * Registra un mensaje acerca de una condici&oacute;n excepcional generada en
	 ...
	 * <p>
	 * Registra informaci&oacute;n cuando cierto evento ocurre.
	 * </p>
	 * 
	 * @param txt
	 *            a string representing the message to include in the app's log
